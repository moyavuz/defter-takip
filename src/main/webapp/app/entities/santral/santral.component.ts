...
export class SantralComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.santralService
            ...
            .subscribe(
                (res: HttpResponse<ISantral[]>) => this.paginateSantrals(res.body, res.headers),
    ...
    protected paginateSantrals(data: ISantral[], headers: HttpHeaders) {
