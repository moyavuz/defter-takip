...
export class MalzemeTakipComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.malzemeTakipService
            ...
            .subscribe(
                (res: HttpResponse<IMalzemeTakip[]>) => this.paginateMalzemeTakips(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/malzeme-takip'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginateMalzemeTakips(data: IMalzemeTakip[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.malzemeTakips = data;
    }
