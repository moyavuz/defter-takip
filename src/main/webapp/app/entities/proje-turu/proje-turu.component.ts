...
export class ProjeTuruComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.projeTuruService
            ...
            .subscribe(
                (res: HttpResponse<IProjeTuru[]>) => this.paginateProjeTurus(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/proje-turu'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginateProjeTurus(data: IProjeTuru[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.projeTurus = data;
    }
