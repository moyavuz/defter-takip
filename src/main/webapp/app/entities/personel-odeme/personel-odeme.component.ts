...
export class PersonelOdemeComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.personelOdemeService
            ...
            .subscribe(
                (res: HttpResponse<IPersonelOdeme[]>) => this.paginatePersonelOdemes(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/personel-odeme'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginatePersonelOdemes(data: IPersonelOdeme[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.personelOdemes = data;
    }
