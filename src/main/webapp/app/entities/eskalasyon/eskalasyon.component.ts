...
export class EskalasyonComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.eskalasyonService
            ...
            .subscribe(
                (res: HttpResponse<IEskalasyon[]>) => this.paginateEskalasyons(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/eskalasyon'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginateEskalasyons(data: IEskalasyon[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.eskalasyons = data;
    }
