...
export class MalzemeComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.malzemeService
            ...
            .subscribe(
                (res: HttpResponse<IMalzeme[]>) => this.paginateMalzemes(res.body, res.headers),
    ...
    protected paginateMalzemes(data: IMalzeme[], headers: HttpHeaders) {
