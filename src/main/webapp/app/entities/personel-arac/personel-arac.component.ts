...
export class PersonelAracComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.personelAracService
            ...
            .subscribe(
                (res: HttpResponse<IPersonelArac[]>) => this.paginatePersonelAracs(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/personel-arac'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginatePersonelAracs(data: IPersonelArac[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.personelAracs = data;
    }
