...
export class ProjeService {
    ...
    protected convertDateFromClient(proje: IProje): IProje {
        const copy: IProje = Object.assign({}, proje, {
            tarih: proje.tarih != null && proje.tarih.isValid() ? proje.tarih.toJSON() : null,
            baslamaTarihi: proje.baslamaTarihi != null && proje.baslamaTarihi.isValid() ? proje.baslamaTarihi.toJSON() : null,
            bitisTarihi: proje.bitisTarihi != null && proje.bitisTarihi.isValid() ? proje.bitisTarihi.toJSON() : null
        });
        return copy;
    }
