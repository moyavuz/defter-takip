...
export class ZimmetTuruComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.zimmetTuruService
            ...
            .subscribe(
                (res: HttpResponse<IZimmetTuru[]>) => this.paginateZimmetTurus(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/zimmet-turu'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginateZimmetTurus(data: IZimmetTuru[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.zimmetTurus = data;
    }
