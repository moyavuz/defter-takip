...
export class DovizKurComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.dovizKurService
            ...
            .subscribe(
                (res: HttpResponse<IDovizKur[]>) => this.paginateDovizKurs(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/doviz-kur'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    protected paginateDovizKurs(data: IDovizKur[], headers: HttpHeaders) {
