...
export class MudurlukComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.mudurlukService
            ...
            .subscribe(
                (res: HttpResponse<IMudurluk[]>) => this.paginateMudurluks(res.body, res.headers),
    ...
    protected paginateMudurluks(data: IMudurluk[], headers: HttpHeaders) {
