...
public class ProjeResource {
     ...
     */
    @PostMapping("/projes")
    public ResponseEntity<Proje> createProje(@Valid @RequestBody Proje proje) throws URISyntaxException {
     ...
     */
    @PutMapping("/projes")
    public ResponseEntity<Proje> updateProje(@Valid @RequestBody Proje proje) throws URISyntaxException {
