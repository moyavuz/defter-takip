...
public class EskalasyonResource {
    ...
    public ResponseEntity<List<Eskalasyon>> getAllEskalasyons(EskalasyonCriteria criteria, Pageable pageable) {
        log.debug("REST request to get Eskalasyons by criteria: {}", criteria);
        Page<Eskalasyon> page = eskalasyonQueryService.findByCriteria(criteria, pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/eskalasyons");
