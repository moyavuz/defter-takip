...
public class PersonelAracResource {
    ...
    public ResponseEntity<List<PersonelArac>> getAllPersonelAracs(PersonelAracCriteria criteria, Pageable pageable) {
        log.debug("REST request to get PersonelAracs by criteria: {}", criteria);
        Page<PersonelArac> page = personelAracQueryService.findByCriteria(criteria, pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/personel-aracs");
