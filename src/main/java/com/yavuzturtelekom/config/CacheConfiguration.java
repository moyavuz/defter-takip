...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.yavuzturtelekom.domain.HakedisTuru.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(com.yavuzturtelekom.domain.PozGrubu.class.getName(), jcacheConfiguration);
            cm.createCache(com.yavuzturtelekom.domain.PozGrubu.class.getName() + ".pozListesis", jcacheConfiguration);
            ...
            cm.createCache(com.yavuzturtelekom.domain.Poz.class.getName() + ".grups", jcacheConfiguration);
            cm.createCache(com.yavuzturtelekom.domain.Il.class.getName(), jcacheConfiguration);
            cm.createCache(com.yavuzturtelekom.domain.Mudurluk.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(com.yavuzturtelekom.domain.EskalasyonTuru.class.getName(), jcacheConfiguration);
            cm.createCache(com.yavuzturtelekom.domain.Eskalasyon.class.getName(), jcacheConfiguration);
