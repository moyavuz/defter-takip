...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.yavuzturtelekom.domain.Ekip.class.getName() + ".ekips", jcacheConfiguration);
            ...
            cm.createCache(com.yavuzturtelekom.domain.Malzeme.class.getName() + ".malzemes", jcacheConfiguration);
