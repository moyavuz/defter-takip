...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.yavuzturtelekom.domain.Calisan.class.getName() + ".sorumlus", jcacheConfiguration);
            ...
            cm.createCache(com.yavuzturtelekom.domain.Birim.class.getName() + ".birims", jcacheConfiguration);
