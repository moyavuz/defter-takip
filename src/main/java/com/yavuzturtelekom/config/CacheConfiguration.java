...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.yavuzturtelekom.domain.Calisan.class.getName() + ".bolgeSorumlus", jcacheConfiguration);
            ...
            cm.createCache(com.yavuzturtelekom.domain.Ekip.class.getName() + ".calisanEkips", jcacheConfiguration);
            cm.createCache(com.yavuzturtelekom.domain.Ekip.class.getName() + ".ekipSorumlus", jcacheConfiguration);
            ...
            cm.createCache(com.yavuzturtelekom.domain.Birim.class.getName() + ".iscilikBirims", jcacheConfiguration);
            ...
            cm.createCache(com.yavuzturtelekom.domain.Malzeme.class.getName() + ".malzemeIsciliks", jcacheConfiguration);
            ...
            cm.createCache(com.yavuzturtelekom.domain.Bolge.class.getName() + ".bolges", jcacheConfiguration);
            cm.createCache(com.yavuzturtelekom.domain.Proje.class.getName(), jcacheConfiguration);
            cm.createCache(com.yavuzturtelekom.domain.Proje.class.getName() + ".projeIsciliks", jcacheConfiguration);
            ...
            cm.createCache(com.yavuzturtelekom.domain.Iscilik.class.getName() + ".malzemes", jcacheConfiguration);
