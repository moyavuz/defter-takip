...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.yavuzturtelekom.domain.Calisan.class.getName() + ".bolges", jcacheConfiguration);
            ...
            cm.createCache(com.yavuzturtelekom.domain.Poz.class.getName() + ".pozs", jcacheConfiguration);
            ...
            cm.createCache(com.yavuzturtelekom.domain.Proje.class.getName() + ".projes", jcacheConfiguration);
