...
public class Proje implements Serializable {
    ...
    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    @JoinTable(name = "proje_proje_iscilik",
               joinColumns = @JoinColumn(name = "proje_id", referencedColumnName = "id"),
               inverseJoinColumns = @JoinColumn(name = "proje_iscilik_id", referencedColumnName = "id"))
    private Set<Iscilik> projeIsciliks = new HashSet<>();
    ...
    public Set<Iscilik> getProjeIsciliks() {
        return projeIsciliks;
    }

    public Proje projeIsciliks(Set<Iscilik> isciliks) {
        this.projeIsciliks = isciliks;
        return this;
    }

    public Proje addProjeIscilik(Iscilik iscilik) {
        this.projeIsciliks.add(iscilik);
        iscilik.getProjes().add(this);
        return this;
    }

    public Proje removeProjeIscilik(Iscilik iscilik) {
        this.projeIsciliks.remove(iscilik);
        iscilik.getProjes().remove(this);
        return this;
    }

    public void setProjeIsciliks(Set<Iscilik> isciliks) {
        this.projeIsciliks = isciliks;
    }
