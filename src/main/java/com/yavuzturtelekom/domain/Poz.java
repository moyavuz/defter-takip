...
public class Poz implements Serializable {
    ...
    public Poz malzeme(Malzeme malzeme) {
    ...
    public Poz birims(Set<Birim> birims) {
        this.birims = birims;
        return this;
    }

    public Poz addBirim(Birim birim) {
        this.birims.add(birim);
        birim.setPoz(this);
        return this;
    }

    public Poz removeBirim(Birim birim) {
    ...
    public Poz iscilik(Iscilik iscilik) {
