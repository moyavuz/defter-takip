...
public class Poz implements Serializable {
    ...
    @Column(name = "ihale_sahasi")
    private String ihaleSahasi;
    ...
    public String getIhaleSahasi() {
        return ihaleSahasi;
    }

    public Poz ihaleSahasi(String ihaleSahasi) {
        this.ihaleSahasi = ihaleSahasi;
        return this;
    }

    public void setIhaleSahasi(String ihaleSahasi) {
        this.ihaleSahasi = ihaleSahasi;
    }
