...
public class Ekip implements Serializable {
    ...
    @OneToMany(mappedBy = "malzemeAlanEkip")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<MalzemeTakip> malzemeAlanEkips = new HashSet<>();
    @ManyToOne
    ...
    public Set<MalzemeTakip> getMalzemeAlanEkips() {
        return malzemeAlanEkips;
    }

    public Ekip malzemeAlanEkips(Set<MalzemeTakip> malzemeTakips) {
        this.malzemeAlanEkips = malzemeTakips;
        return this;
    }

    public Ekip addMalzemeAlanEkip(MalzemeTakip malzemeTakip) {
        this.malzemeAlanEkips.add(malzemeTakip);
        malzemeTakip.setMalzemeAlanEkip(this);
        return this;
    }

    public Ekip removeMalzemeAlanEkip(MalzemeTakip malzemeTakip) {
        this.malzemeAlanEkips.remove(malzemeTakip);
        malzemeTakip.setMalzemeAlanEkip(null);
        return this;
    }

    public void setMalzemeAlanEkips(Set<MalzemeTakip> malzemeTakips) {
        this.malzemeAlanEkips = malzemeTakips;
    }
