...
public class Ekip implements Serializable {
    ...
    @OneToMany(mappedBy = "ekip")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<Calisan> ekipSorumlus = new HashSet<>();
    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    ...
    public Set<Calisan> getEkipSorumlus() {
        return ekipSorumlus;
    }

    public Ekip ekipSorumlus(Set<Calisan> calisans) {
        this.ekipSorumlus = calisans;
        return this;
    }

    public Ekip addEkipSorumlu(Calisan calisan) {
        this.ekipSorumlus.add(calisan);
        calisan.setEkip(this);
        return this;
    }

    public Ekip removeEkipSorumlu(Calisan calisan) {
        this.ekipSorumlus.remove(calisan);
        calisan.setEkip(null);
        return this;
    }

    public void setEkipSorumlus(Set<Calisan> calisans) {
        this.ekipSorumlus = calisans;
    }
