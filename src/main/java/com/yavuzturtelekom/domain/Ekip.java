...
public class Ekip implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<MalzemeTakip> ekips = new HashSet<>();
    @ManyToOne
    ...
    public Set<MalzemeTakip> getEkips() {
        return ekips;
    }

    public Ekip ekips(Set<MalzemeTakip> malzemeTakips) {
        this.ekips = malzemeTakips;
        return this;
    }

    public Ekip addEkip(MalzemeTakip malzemeTakip) {
        this.ekips.add(malzemeTakip);
        malzemeTakip.setEkip(this);
        return this;
    }

    public Ekip removeEkip(MalzemeTakip malzemeTakip) {
        this.ekips.remove(malzemeTakip);
        malzemeTakip.setEkip(null);
        return this;
    }

    public void setEkips(Set<MalzemeTakip> malzemeTakips) {
        this.ekips = malzemeTakips;
    }
