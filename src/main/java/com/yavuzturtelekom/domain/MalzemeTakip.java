...
public class MalzemeTakip implements Serializable {
    ...
    private Ekip ekipMalzemeTakip;

    @ManyToOne
    @JsonIgnoreProperties("malzemes")
    private Malzeme malzemeMalzemeTakip;
    ...
    public Ekip getEkipMalzemeTakip() {
        return ekipMalzemeTakip;
    }

    public MalzemeTakip ekipMalzemeTakip(Ekip ekip) {
        this.ekipMalzemeTakip = ekip;
        return this;
    }

    public void setEkipMalzemeTakip(Ekip ekip) {
        this.ekipMalzemeTakip = ekip;
    }

    public Malzeme getMalzemeMalzemeTakip() {
        return malzemeMalzemeTakip;
    }

    public MalzemeTakip malzemeMalzemeTakip(Malzeme malzeme) {
        this.malzemeMalzemeTakip = malzeme;
        return this;
    }

    public void setMalzemeMalzemeTakip(Malzeme malzeme) {
        this.malzemeMalzemeTakip = malzeme;
    }
