...
public class Birim implements Serializable {
    ...
    @OneToMany(mappedBy = "birim")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<Iscilik> iscilikBirims = new HashSet<>();
    @OneToMany(mappedBy = "birim")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    ...
    public Set<Iscilik> getIscilikBirims() {
        return iscilikBirims;
    }

    public Birim iscilikBirims(Set<Iscilik> isciliks) {
        this.iscilikBirims = isciliks;
        return this;
    }

    public Birim addIscilikBirim(Iscilik iscilik) {
        this.iscilikBirims.add(iscilik);
        iscilik.setBirim(this);
        return this;
    }

    public Birim removeIscilikBirim(Iscilik iscilik) {
        this.iscilikBirims.remove(iscilik);
        iscilik.setBirim(null);
        return this;
    }

    public void setIscilikBirims(Set<Iscilik> isciliks) {
        this.iscilikBirims = isciliks;
    }
