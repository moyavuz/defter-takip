...
public class Birim implements Serializable {
    ...
    public Long getCarpani() {
        return carpani;
    }

    public Birim carpani(Long carpani) {
        this.carpani = carpani;
        return this;
    }

    public void setCarpani(Long carpani) {
        this.carpani = carpani;
    }
    ...
    public Birim aktifMi(Boolean aktifMi) {
