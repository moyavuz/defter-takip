...
public class Malzeme implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<MalzemeTakip> malzemeMalzemeTakips = new HashSet<>();
    ...
    public Set<MalzemeTakip> getMalzemeMalzemeTakips() {
        return malzemeMalzemeTakips;
    }

    public Malzeme malzemeMalzemeTakips(Set<MalzemeTakip> malzemeTakips) {
        this.malzemeMalzemeTakips = malzemeTakips;
        return this;
    }

    public Malzeme addMalzemeMalzemeTakip(MalzemeTakip malzemeTakip) {
        this.malzemeMalzemeTakips.add(malzemeTakip);
        malzemeTakip.setMalzeme(this);
        return this;
    }

    public Malzeme removeMalzemeMalzemeTakip(MalzemeTakip malzemeTakip) {
        this.malzemeMalzemeTakips.remove(malzemeTakip);
        malzemeTakip.setMalzeme(null);
        return this;
    }

    public void setMalzemeMalzemeTakips(Set<MalzemeTakip> malzemeTakips) {
        this.malzemeMalzemeTakips = malzemeTakips;
    }
