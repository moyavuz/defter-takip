...
public class Malzeme implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<MalzemeTakip> malzemes = new HashSet<>();
    ...
    public Set<MalzemeTakip> getMalzemes() {
        return malzemes;
    }

    public Malzeme malzemes(Set<MalzemeTakip> malzemeTakips) {
        this.malzemes = malzemeTakips;
        return this;
    }

    public Malzeme addMalzeme(MalzemeTakip malzemeTakip) {
        this.malzemes.add(malzemeTakip);
        malzemeTakip.setMalzeme(this);
        return this;
    }

    public Malzeme removeMalzeme(MalzemeTakip malzemeTakip) {
        this.malzemes.remove(malzemeTakip);
        malzemeTakip.setMalzeme(null);
        return this;
    }

    public void setMalzemes(Set<MalzemeTakip> malzemeTakips) {
        this.malzemes = malzemeTakips;
    }
