...
public class Malzeme implements Serializable {
    ...
    @OneToMany(mappedBy = "malzemeTakipProje")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<MalzemeTakip> malzemeTakipProjes = new HashSet<>();
    ...
    public Set<MalzemeTakip> getMalzemeTakipProjes() {
        return malzemeTakipProjes;
    }

    public Malzeme malzemeTakipProjes(Set<MalzemeTakip> malzemeTakips) {
        this.malzemeTakipProjes = malzemeTakips;
        return this;
    }

    public Malzeme addMalzemeTakipProje(MalzemeTakip malzemeTakip) {
        this.malzemeTakipProjes.add(malzemeTakip);
        malzemeTakip.setMalzemeTakipProje(this);
        return this;
    }

    public Malzeme removeMalzemeTakipProje(MalzemeTakip malzemeTakip) {
        this.malzemeTakipProjes.remove(malzemeTakip);
        malzemeTakip.setMalzemeTakipProje(null);
        return this;
    }

    public void setMalzemeTakipProjes(Set<MalzemeTakip> malzemeTakips) {
        this.malzemeTakipProjes = malzemeTakips;
    }
