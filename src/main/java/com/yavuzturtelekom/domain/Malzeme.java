...
public class Malzeme implements Serializable {
    ...
    @Column(name = "fiyat_maliyet")
    private Double fiyatMaliyet;
    ...
    public Double getFiyatMaliyet() {
        return fiyatMaliyet;
    }

    public Malzeme fiyatMaliyet(Double fiyatMaliyet) {
        this.fiyatMaliyet = fiyatMaliyet;
        return this;
    }

    public void setFiyatMaliyet(Double fiyatMaliyet) {
        this.fiyatMaliyet = fiyatMaliyet;
    }
    ...
    public Malzeme malzemeTakips(Set<MalzemeTakip> malzemeTakips) {
        this.malzemeTakips = malzemeTakips;
        return this;
    }

    public Malzeme addMalzemeTakip(MalzemeTakip malzemeTakip) {
        this.malzemeTakips.add(malzemeTakip);
        malzemeTakip.setMalzeme(this);
        return this;
    }

    public Malzeme removeMalzemeTakip(MalzemeTakip malzemeTakip) {
