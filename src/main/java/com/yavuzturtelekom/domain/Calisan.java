...
public class Calisan implements Serializable {
    ...
    public Calisan ucret(Double ucret) {
        this.ucret = ucret;
        return this;
    }
    ...
    public Calisan resim(byte[] resim) {
        this.resim = resim;
        return this;
    }
    ...
    public Calisan resimContentType(String resimContentType) {
    ...
    public Calisan dosya(byte[] dosya) {
        this.dosya = dosya;
        return this;
    }
    ...
    public Calisan dosyaContentType(String dosyaContentType) {
