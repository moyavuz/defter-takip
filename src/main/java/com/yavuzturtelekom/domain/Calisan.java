...
public class Calisan implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<Bolge> bolgeSorumlus = new HashSet<>();
    @ManyToOne
    ...
    @ManyToOne
    @JsonIgnoreProperties("ekipSorumlus")
    private Ekip ekip;

    @ManyToOne
    @JsonIgnoreProperties("unvans")
    private Unvan unvan;
    ...
    public Set<Bolge> getBolgeSorumlus() {
        return bolgeSorumlus;
    }

    public Calisan bolgeSorumlus(Set<Bolge> bolges) {
        this.bolgeSorumlus = bolges;
        return this;
    }

    public Calisan addBolgeSorumlu(Bolge bolge) {
        this.bolgeSorumlus.add(bolge);
        bolge.setCalisan(this);
        return this;
    }

    public Calisan removeBolgeSorumlu(Bolge bolge) {
        this.bolgeSorumlus.remove(bolge);
        bolge.setCalisan(null);
        return this;
    }

    public void setBolgeSorumlus(Set<Bolge> bolges) {
        this.bolgeSorumlus = bolges;
    }
