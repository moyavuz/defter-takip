...
public class Calisan implements Serializable {
    ...
    @OneToMany(mappedBy = "sorumluCalisan")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    ...
    public Calisan bolges(Set<Bolge> bolges) {
        this.bolges = bolges;
        return this;
    }

    public Calisan addBolge(Bolge bolge) {
        this.bolges.add(bolge);
        bolge.setSorumluCalisan(this);
        return this;
    }

    public Calisan removeBolge(Bolge bolge) {
        this.bolges.remove(bolge);
        bolge.setSorumluCalisan(null);
        return this;
    }
