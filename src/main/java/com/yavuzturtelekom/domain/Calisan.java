...
public class Calisan implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<Bolge> sorumlus = new HashSet<>();
    @ManyToOne
    ...
    public Set<Bolge> getSorumlus() {
        return sorumlus;
    }

    public Calisan sorumlus(Set<Bolge> bolges) {
        this.sorumlus = bolges;
        return this;
    }

    public Calisan addSorumlu(Bolge bolge) {
        this.sorumlus.add(bolge);
        bolge.setCalisan(this);
        return this;
    }

    public Calisan removeSorumlu(Bolge bolge) {
        this.sorumlus.remove(bolge);
        bolge.setCalisan(null);
        return this;
    }

    public void setSorumlus(Set<Bolge> bolges) {
        this.sorumlus = bolges;
    }
