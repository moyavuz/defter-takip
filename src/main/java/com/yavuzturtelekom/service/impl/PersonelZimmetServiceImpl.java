...
public class PersonelZimmetServiceImpl implements PersonelZimmetService {
    ...
    public Page<PersonelZimmet> findAll(Pageable pageable) {
        log.debug("Request to get all PersonelZimmets");
        return personelZimmetRepository.findAll(pageable);
    }
    ...
    public void delete(Long id) {
        log.debug("Request to delete PersonelZimmet : {}", id);
        personelZimmetRepository.deleteById(id);
    }
}
