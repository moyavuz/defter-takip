...
public class MudurlukServiceImpl implements MudurlukService {
    ...
    public Page<Mudurluk> findAll(Pageable pageable) {
        log.debug("Request to get all Mudurluks");
        return mudurlukRepository.findAll(pageable);
    }
    ...
    public void delete(Long id) {
        log.debug("Request to delete Mudurluk : {}", id);
        mudurlukRepository.deleteById(id);
    }
}
