...
import { HakedisComponent } from 'app/entities/hakedis/hakedis.component';
import { HakedisService } from 'app/entities/hakedis/hakedis.service';
import { Hakedis } from 'app/shared/model/hakedis.model';

describe('Component Tests', () => {
    describe('Hakedis Management Component', () => {
        let comp: HakedisComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(HakedisComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.hakedis[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
