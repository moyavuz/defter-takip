...
import { CalisanComponent } from 'app/entities/calisan/calisan.component';
import { CalisanService } from 'app/entities/calisan/calisan.service';
import { Calisan } from 'app/shared/model/calisan.model';

describe('Component Tests', () => {
    describe('Calisan Management Component', () => {
        let comp: CalisanComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CalisanComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.calisans[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
