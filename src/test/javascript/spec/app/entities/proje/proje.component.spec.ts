...
import { ProjeComponent } from 'app/entities/proje/proje.component';
import { ProjeService } from 'app/entities/proje/proje.service';
import { Proje } from 'app/shared/model/proje.model';

describe('Component Tests', () => {
    describe('Proje Management Component', () => {
        let comp: ProjeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ProjeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.projes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
