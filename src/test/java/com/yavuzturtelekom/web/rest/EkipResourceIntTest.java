...
public class EkipResourceIntTest {
    ...
    private static final Double DEFAULT_TENZILAT_ORAN = 1D;
    private static final Double UPDATED_TENZILAT_ORAN = 2D;
    ...
    public static Ekip createEntity(EntityManager em) {
        Ekip ekip = new Ekip()
            ...
            .turu(DEFAULT_TURU)
            .tenzilatOran(DEFAULT_TENZILAT_ORAN);
        // Add required entity
    ...
    public void createEkip() throws Exception {
        ...
        assertThat(testEkip.getTenzilatOran()).isEqualTo(DEFAULT_TENZILAT_ORAN);
    }
    ...
    public void getAllEkips() throws Exception {
        ...
        restEkipMockMvc.perform(get("/api/ekips?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].tenzilatOran").value(hasItem(DEFAULT_TENZILAT_ORAN.doubleValue())));
    }
    ...
    public void getEkip() throws Exception {
        ...
        restEkipMockMvc.perform(get("/api/ekips/{id}", ekip.getId()))
            ...
            .andExpect(jsonPath("$.tenzilatOran").value(DEFAULT_TENZILAT_ORAN.doubleValue()));
    }
    ...
    @Test
    @Transactional
    public void getAllEkipsByTenzilatOranIsEqualToSomething() throws Exception {
        // Initialize the database
        ekipRepository.saveAndFlush(ekip);

        // Get all the ekipList where tenzilatOran equals to DEFAULT_TENZILAT_ORAN
        defaultEkipShouldBeFound("tenzilatOran.equals=" + DEFAULT_TENZILAT_ORAN);

        // Get all the ekipList where tenzilatOran equals to UPDATED_TENZILAT_ORAN
        defaultEkipShouldNotBeFound("tenzilatOran.equals=" + UPDATED_TENZILAT_ORAN);
    }

    @Test
    @Transactional
    public void getAllEkipsByTenzilatOranIsInShouldWork() throws Exception {
        // Initialize the database
        ekipRepository.saveAndFlush(ekip);

        // Get all the ekipList where tenzilatOran in DEFAULT_TENZILAT_ORAN or UPDATED_TENZILAT_ORAN
        defaultEkipShouldBeFound("tenzilatOran.in=" + DEFAULT_TENZILAT_ORAN + "," + UPDATED_TENZILAT_ORAN);

        // Get all the ekipList where tenzilatOran equals to UPDATED_TENZILAT_ORAN
        defaultEkipShouldNotBeFound("tenzilatOran.in=" + UPDATED_TENZILAT_ORAN);
    }

    @Test
    @Transactional
    public void getAllEkipsByTenzilatOranIsNullOrNotNull() throws Exception {
        // Initialize the database
        ekipRepository.saveAndFlush(ekip);

        // Get all the ekipList where tenzilatOran is not null
        defaultEkipShouldBeFound("tenzilatOran.specified=true");

        // Get all the ekipList where tenzilatOran is null
        defaultEkipShouldNotBeFound("tenzilatOran.specified=false");
    }
    ...
    public void updateEkip() throws Exception {
        ...
        updatedEkip
            ...
            .turu(UPDATED_TURU)
            .tenzilatOran(UPDATED_TENZILAT_ORAN);
        ...
        assertThat(testEkip.getTenzilatOran()).isEqualTo(UPDATED_TENZILAT_ORAN);
    }
