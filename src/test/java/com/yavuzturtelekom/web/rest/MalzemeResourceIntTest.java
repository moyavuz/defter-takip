...
public class MalzemeResourceIntTest {
    ...
    private static final BigDecimal DEFAULT_FIYAT_GELIS = new BigDecimal(1);
    private static final BigDecimal UPDATED_FIYAT_GELIS = new BigDecimal(2);
    ...
    public static Malzeme createEntity(EntityManager em) {
        Malzeme malzeme = new Malzeme()
            ...
            .fiyatGelis(DEFAULT_FIYAT_GELIS)
    ...
    public void createMalzeme() throws Exception {
        ...
        assertThat(testMalzeme.getFiyatGelis()).isEqualTo(DEFAULT_FIYAT_GELIS);
        assertThat(testMalzeme.isAktifMi()).isEqualTo(DEFAULT_AKTIF_MI);
    }
    ...
    public void getAllMalzemes() throws Exception {
        ...
        restMalzemeMockMvc.perform(get("/api/malzemes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].fiyatGelis").value(hasItem(DEFAULT_FIYAT_GELIS.intValue())))
    ...
    public void getMalzeme() throws Exception {
        ...
        restMalzemeMockMvc.perform(get("/api/malzemes/{id}", malzeme.getId()))
            ...
            .andExpect(jsonPath("$.fiyatGelis").value(DEFAULT_FIYAT_GELIS.intValue()))
    ...
    public void updateMalzeme() throws Exception {
        ...
        updatedMalzeme
            ...
            .fiyatGelis(UPDATED_FIYAT_GELIS)
        ...
        assertThat(testMalzeme.getFiyatGelis()).isEqualTo(UPDATED_FIYAT_GELIS);
        assertThat(testMalzeme.isAktifMi()).isEqualTo(UPDATED_AKTIF_MI);
    }
