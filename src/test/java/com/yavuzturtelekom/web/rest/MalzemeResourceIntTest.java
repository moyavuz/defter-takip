...
public class MalzemeResourceIntTest {
    ...
    private static final Double DEFAULT_FIYAT_MALIYET = 1D;
    private static final Double UPDATED_FIYAT_MALIYET = 2D;
    ...
    public void getAllMalzemes() throws Exception {
        ...
        restMalzemeMockMvc.perform(get("/api/malzemes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].fiyatMaliyet").value(hasItem(DEFAULT_FIYAT_MALIYET.doubleValue())));
    }
    ...
    public void getMalzeme() throws Exception {
        ...
        restMalzemeMockMvc.perform(get("/api/malzemes/{id}", malzeme.getId()))
            ...
            .andExpect(jsonPath("$.fiyatMaliyet").value(DEFAULT_FIYAT_MALIYET.doubleValue()));
    }
