...
public class PozResourceIntTest {
    ...
    private static final Double DEFAULT_FIYAT_TELEKOM = 1D;
    private static final Double UPDATED_FIYAT_TELEKOM = 2D;

    private static final Double DEFAULT_FIYAT_GIRISIM = 1D;
    private static final Double UPDATED_FIYAT_GIRISIM = 2D;

    private static final Double DEFAULT_FIYAT_TASERON = 1D;
    private static final Double UPDATED_FIYAT_TASERON = 2D;

    private static final Double DEFAULT_FIYAT_TASERE = 1D;
    private static final Double UPDATED_FIYAT_TASERE = 2D;

    private static final Double DEFAULT_KDV = 1D;
    private static final Double UPDATED_KDV = 2D;
    ...
    public void createPoz() throws Exception {
        ...
        assertThat(testPoz.getKdv()).isEqualTo(DEFAULT_KDV);
    ...
    public void getAllPozs() throws Exception {
        ...
        restPozMockMvc.perform(get("/api/pozs?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].fiyatTelekom").value(hasItem(DEFAULT_FIYAT_TELEKOM.doubleValue())))
            .andExpect(jsonPath("$.[*].fiyatGirisim").value(hasItem(DEFAULT_FIYAT_GIRISIM.doubleValue())))
            .andExpect(jsonPath("$.[*].fiyatTaseron").value(hasItem(DEFAULT_FIYAT_TASERON.doubleValue())))
            .andExpect(jsonPath("$.[*].fiyatTasere").value(hasItem(DEFAULT_FIYAT_TASERE.doubleValue())))
            .andExpect(jsonPath("$.[*].kdv").value(hasItem(DEFAULT_KDV.doubleValue())))
    ...
    public void getPoz() throws Exception {
        ...
        restPozMockMvc.perform(get("/api/pozs/{id}", poz.getId()))
            ...
            .andExpect(jsonPath("$.fiyatTelekom").value(DEFAULT_FIYAT_TELEKOM.doubleValue()))
            .andExpect(jsonPath("$.fiyatGirisim").value(DEFAULT_FIYAT_GIRISIM.doubleValue()))
            .andExpect(jsonPath("$.fiyatTaseron").value(DEFAULT_FIYAT_TASERON.doubleValue()))
            .andExpect(jsonPath("$.fiyatTasere").value(DEFAULT_FIYAT_TASERE.doubleValue()))
            .andExpect(jsonPath("$.kdv").value(DEFAULT_KDV.doubleValue()))
    ...
    public void updatePoz() throws Exception {
        ...
        assertThat(testPoz.getKdv()).isEqualTo(UPDATED_KDV);
