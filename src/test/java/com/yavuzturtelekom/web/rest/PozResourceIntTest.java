...
public class PozResourceIntTest {
    ...
    private static final Double DEFAULT_KDV_ORAN = 1D;
    private static final Double UPDATED_KDV_ORAN = 2D;
    ...
    public void createPoz() throws Exception {
        ...
        assertThat(testPoz.getKdvOran()).isEqualTo(DEFAULT_KDV_ORAN);
    ...
    @Test
    @Transactional
    public void checkKisaltmaIsRequired() throws Exception {
        int databaseSizeBeforeTest = pozRepository.findAll().size();
        // set the field null
        poz.setKisaltma(null);
    ...
    public void getAllPozs() throws Exception {
        ...
        restPozMockMvc.perform(get("/api/pozs?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].kdvOran").value(hasItem(DEFAULT_KDV_ORAN.doubleValue())))
    ...
    public void getPoz() throws Exception {
        ...
        restPozMockMvc.perform(get("/api/pozs/{id}", poz.getId()))
            ...
            .andExpect(jsonPath("$.kdvOran").value(DEFAULT_KDV_ORAN.doubleValue()))
    ...
    public void updatePoz() throws Exception {
        ...
        assertThat(testPoz.getKdvOran()).isEqualTo(UPDATED_KDV_ORAN);
