...
public class IscilikResourceIntTest {
    ...
    public void createIscilik() throws Exception {
        ...
        assertThat(testIscilik.getResim()).isEqualTo(DEFAULT_RESIM);
        assertThat(testIscilik.getResimContentType()).isEqualTo(DEFAULT_RESIM_CONTENT_TYPE);
    }
    ...
    public void checkMiktarIsRequired() throws Exception {
        int databaseSizeBeforeTest = iscilikRepository.findAll().size();
        // set the field null
        iscilik.setMiktar(null);

        // Create the Iscilik, which fails.
        ...
        List<Iscilik> iscilikList = iscilikRepository.findAll();
        assertThat(iscilikList).hasSize(databaseSizeBeforeTest);
    }
    ...
    public void updateIscilik() throws Exception {
        ...
        assertThat(testIscilik.getResim()).isEqualTo(UPDATED_RESIM);
        assertThat(testIscilik.getResimContentType()).isEqualTo(UPDATED_RESIM_CONTENT_TYPE);
    }
